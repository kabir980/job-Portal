                            ...
                            <div class="card-body card-form p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="textarea" name="responsibility" id="responsibility" cols="5" rows="5"
                                        placeholder="Responsibility">{{$job->responsility}}</textarea>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{$job->company_website}}" placeholder="Website" id="company_website" name="website"
                                        class="form-control">
                                </div>
                            </div>
...
@section('customJs')
    <script type="text/javascript">
        $("#editJobForm").submit(function(e) {
            ...
            e.preventDefault();
            $("textarea='submit']").prop("disabled", true);
